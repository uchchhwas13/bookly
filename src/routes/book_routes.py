...
book_router = APIRouter(dependencies=[Depends(access_token_bearer)])
...
async def get_book(book_uid: str, session: Annotated[AsyncSession, Depends(get_session)]):
...
async def update_book(book_uid: str, book_update_data: BookUpdateModel, session: Annotated[AsyncSession, Depends(get_session)]):
...
async def delete_book(book_uid: str, session: Annotated[AsyncSession, Depends(get_session)]):
