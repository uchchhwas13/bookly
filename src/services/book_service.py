...
class BookService:
    ...
    async def create_book(self, user_uid: UUID, book_data: BookCreateModel, session: AsyncSession) -> Book:
    ...
    async def delete_book(self, book_uid: str, session: AsyncSession) -> Optional[Book]:
